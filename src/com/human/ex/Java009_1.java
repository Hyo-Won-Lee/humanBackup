...
public class Java009_1 {
	...
	public static void main(String[] args) {	
		...
		int listCount=3;
		String id[]=new String[100];	//데이터는 최상단에 위치한다.
		...
		while(true) {
			...
			}else if(inputId.equals("exit")&&inputPw.equals("exit")){
				break;
...
//						if(id[i].equals(inputId)&&id[i]!=null) //잘못된 코드다.
		...
		//String loginId=""; //null 문자만 heap에 들어있음. loginId 0x01
		//String loginId=null; //해당되어있지 않음. loginId null
		//loginId.equals("null");
		//loginId==null;
